            ...
            <div class="verso-nav-container verso-customizer-menu-layout">
                <div class="verso-nav-brand">
                    <a href="/" class="verso-customizer-menu-logo-text">
                        <img src="{{asset('css/vt-csk/uploads/sites/15/2017/09/commerce-funky-logo-130x100.png')}}"
                ...
                <nav class="verso-nav-menu">
                    <ul id="menu-main-menu" class="verso-nav-list">
                        <li id="menu-item-114"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-112 current_page_item nav-item menu-item-114 active">
                            <a title="Home" href="/">TRANG CHỦ</a></li>
                        <li id="menu-item-115"
                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children nav-item menu-item-115 dropdown">
                            <a title="Shop" href="{{asset('shop')}}">SHOP</a>
                        </li>
                        <li id="menu-item-124"
                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children nav-item menu-item-124 dropdown">
                            <a title="About Us" href="{{route('about_us')}}">VỀ CHÚNG TÔI</a>
                        </li>
                        <li id="menu-item-128"
                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children nav-item menu-item-128 dropdown">
                            <a title="Blog" href="{{route('news')}}">TIN TỨC</a>
                        </li>
                        <li id="menu-item-133"
                            class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-133">
